...
ggsave(file.path('graphs', 'RegResponseHistogram.pdf'))

#Build scatter plot of response variable - Erosion Risk
ggplot(data=TrgData,aes(x=MeanProcFlow,y=MeanMotFlow,colour=ErosionRisk)) +
  geom_point()
ggsave(file.path('graphs', 'ClassResponseScatterPlot.pdf'))
